...
const CategoryItem = ({
  ...
  return (
    <AnimatePresence>
      <motion.div
        className={`flex cursor-pointer flex-col items-center justify-center rounded-lg bg-slate-800 px-12 py-2 ${
          hover ? 'bg-teal-500' : ''
        }`}
...
export default function Category() {
  ...
  return (
    <motion.div
      className="m-4 flex flex-row justify-between gap-4 overflow-hidden rounded-lg bg-slate-900 px-2 py-2"
      animate={{
